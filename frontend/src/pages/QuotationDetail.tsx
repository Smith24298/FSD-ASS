          ...
          <div>
            ...
            >
              <h1 className="page-title">
                Quotation: {quotation.quotationNumber || `QT-${quotation.id}`}
              </h1>
            ...
            >
              For RFQ:{" "}
              <Link
                to={`/rfqs/${quotation.rfq?.id || quotation.rfqId}`}
                style={{ color: "#1E3A8A", fontWeight: 600 }}
              >
                {quotation.rfq?.rfqNumber} — {quotation.rfq?.title}
              </Link>
            </p>
          </div>
          ...
          <div>
            {quotation.status === "DRAFT" && user?.role === "VENDOR" && (
              <div style={{ display: "flex", gap: "0.75rem" }}>
                <Link
                  to={`/rfqs/${quotation.rfqId}/quote?quotationId=${quotation.id}`}
                  className="btn btn-secondary"
                >
          ...
          <div className="card" style={{ padding: "1.5rem" }}>
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 600 }}>
                  ₹{Number(quotation.tax || 0).toLocaleString()}
                </span>
              </div>
            </div>
            <div
          ...
          {user?.role !== "VENDOR" && quotation.vendor && (
            <div className="card" style={{ padding: "1.5rem" }}>
              ...
              <div style={{ fontWeight: 600, fontSize: "0.95rem" }}>
                {quotation.vendor.profile?.companyName || quotation.vendor.name}
              </div>
              <div
                style={{
                  fontSize: "0.8rem",
              ...
              {quotation.vendor.profile?.gstNumber && (
                <div style={{ fontSize: "0.8rem", color: "#6B7280" }}>
                  GST: {quotation.vendor.profile.gstNumber}
                </div>
              )}
            </div>
          )}
